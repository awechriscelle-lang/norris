  ...
  const services = [
    {
      ...
      shortDescription: 'Immortalisez vos moments les plus précieux avec l\'expertise de Norris CODJO, photographe professionnel au Bénin.',
      fullDescription: 'Norris CODJO et son équipe GOD\'S EYE couvrent tous types d\'événements au Bénin : mariages, événements d\'entreprise, conférences, spectacles et célébrations privées. Nous utilisons un équipement professionnel de pointe pour capturer chaque instant avec une qualité exceptionnelle.',
      features: [
        'Shooting mariage et événements privés',
        'Photographie d\'entreprise et corporate au Bénin',
        'Couverture d\'événements sportifs',
        'Portraits professionnels par Norris CODJO',
    ...
    },
    {
      ...
      icon: Plane,
      shortDescription: 'Drone Bénin : explorez de nouveaux horizons avec nos prises de vues aériennes spectaculaires.',
      fullDescription: 'Nos pilotes certifiés au Bénin vous offrent des perspectives uniques grâce à nos drones professionnels. Parfait pour l\'immobilier à Cotonou, l\'événementiel, la publicité ou simplement pour capturer des vues à couper le souffle du Bénin.',
      features: [
        'Pilotage drone par des professionnels certifiés au Bénin',
        'Prises de vues aériennes 4K',
        'Inspection technique par drone',
        'Cartographie et topographie',
        'Couverture d\'événements aériens au Bénin',
